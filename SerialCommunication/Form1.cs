...
namespace SerialCommunication
{
    public partial class Form1 : Form
    {
        ...
        private void buttonConnect_Click(object sender, EventArgs e)
        {
            ...
            {
                labelStatus.Text = "Error" + expectation.Message;
                serialPortArduino.Close();
                radioButtonVerbonden.Checked = false;
                buttonConnect.Text = "Connect";
            }
            ...
            try
            {
                ...
                { 
                   serialPortArduino.ReadExisting();
                    ...
                    antwoord = antwoord.TrimEnd();
                    antwoord = antwoord.Substring(4);
                    int adcPot = Int32.Parse(antwoord);

                    double a = 40.0 / 1023.0;
                    double b = 5.0; 
                    double gewensteTemp = a * adcPot + b;
                    ...
                    antwoord = antwoord.TrimEnd();
                    antwoord= antwoord.Substring(4);
                    int adcLM35 = Int32.Parse(antwoord);

                    double aLM35 = 500.0 / 1023.0;
                    double huidigeTemp = aLM35 * adcLM35;
